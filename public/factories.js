	...
	<div class="gameListContainer" style="margin:20px 0px 20px 0px;"><div class="">chat with friends while reverse engineering acronyms</div></div>
		...
		<div class="sampleAcronymContainer" style="display:flex;">
			...
			<div style="display:flex;justify-content:flex-start;">	
				<div class="borderBlink" style="width:0px;overflow:hidden;white-space:nowrap;text-align:center;" class="sampleAcronym"><b>L</b>aws <b>A</b>gainst <b>T</b>rampolines? <b>U</b>nacceptable. </div>
			</div>
			<div style="flex-basis:25%"></div>
		</div>			
		<div class="sampleAcronymContainer" style="display:flex;">
			<div style="flex-basis:25%"></div>
			<div style="display:flex;justify-content:flex-start;">	
				<div class="borderBlink" style="width:0px;overflow:hidden;white-space:nowrap;text-align:center;" class="sampleAcronym"><b>L</b>et's <b>A</b>ll <b>T</b>rade <b>U</b>ncles </div>
			</div>
			<div style="flex-basis:25%"></div>
		</div>					
		<div class="sampleAcronymContainer" style="display:flex;">
			<div style="flex-basis:25%"></div>
			<div style="display:flex;justify-content:flex-start;">	
				<div class="borderBlink" style="width:0px;overflow:hidden;white-space:nowrap;text-align:center;" class="sampleAcronym"><b>L</b>ouis <b>A</b>armstrong's <b>T</b>rumpet-themed <b>U</b>nderpants</div>
			</div>
			<div style="flex-basis:25%"></div>
		</div>`
}
