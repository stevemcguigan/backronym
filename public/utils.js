...
function openMenu()
{
	...
	if (gameId && gameKey)
	{
		detail = `<div style="margin:8px;display:flex;flex-direction:column;justify-content:center;align-items:center;"><div style="margin:8px;">the secret key for this game is</div><div style="font-size:24px;margin:8px;color:olivedrab;"> ${gameKey}</div></div>`
	}	
	else
	{
